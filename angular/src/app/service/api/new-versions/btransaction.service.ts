...
import { ImportBTransactionResult, InComingAndBTransactionDto, PaymentInvoiceForAccount, PaymentInvoiceForAccountMapping } from '@app/service/model/b-transaction.model';
...
export class BtransactionService extends BaseApiService {
  ...
  paymentForAccountMapping(payload: PaymentInvoiceForAccountMapping): Observable<ApiResponse<string>> {
