...
namespace FinanceManagement.Web.Host.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<FirebaseConfig>(_appConfiguration.GetSection("Firebase"));
            ...
            return services.AddAbp<FinanceManagementWebHostModule>(
        ...
        public void Configure(IApplicationBuilder app,  ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint($"/swagger/{_apiVersion}/swagger.json", $"FinanceManagement API {_apiVersion}");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("FinanceManagement.Web.Host.wwwroot.swagger.ui.index.html");
