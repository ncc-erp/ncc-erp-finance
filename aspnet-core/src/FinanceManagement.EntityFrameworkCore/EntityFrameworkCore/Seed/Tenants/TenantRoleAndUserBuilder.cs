...
namespace FinanceManagement.EntityFrameworkCore.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(FinanceManagementDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new FinanceManagementAuthorizationProvider())
        ...
        private void CreateRoleAndAddPermissions(int tenantId)
        {
            ...
            foreach (var roleSeed in roleSeeds)
            {
                ...
                if (role == null)
                {
                    ...
                    {
                        var permissions = PermissionFinder.GetAllPermissions(new FinanceManagementAuthorizationProvider())
                                            .Where(p => p.MultiTenancySides.HasFlag(MultiTenancySides.Tenant) &&
