    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        public override IEnumerable<SettingDefinition> GetSettingDefinitions(SettingDefinitionProviderContext context)
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettingNames.HostMaLoaiChiBangLuong,"luong",scopes:SettingScopes.Application),
                new SettingDefinition(AppSettingNames.TenantMaLoaiChiBangLuong,"luong",scopes:SettingScopes.Tenant),
