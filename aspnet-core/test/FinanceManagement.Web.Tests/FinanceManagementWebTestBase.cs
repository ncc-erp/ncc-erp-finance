...
{
    public abstract class FinanceManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FinanceManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FinanceManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FinanceManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FinanceManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FinanceManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FinanceManagementDbContext, Task<T>> func)
        {
            T result;
